// <auto-generated>
// Regiones (16) y comunas (346) de Chile con su Código Único Territorial (CUT).
// Fuente base: github.com/jromerof/regiones-chile (MIT), corregida: códigos de Ñuble (16xxx),
// código de Huasco (03304) y ortografía de varias comunas.
// </auto-generated>
namespace RRHH.Infrastructure.Persistencia.Semillas;

internal static class DatosUbicacion
{
    internal static readonly (int Id, string Nombre, string Abreviatura, int Orden)[] Regiones =
    [
        (15, "Arica y Parinacota", "XV", 1),
        (1, "Tarapacá", "I", 2),
        (2, "Antofagasta", "II", 3),
        (3, "Atacama", "III", 4),
        (4, "Coquimbo", "IV", 5),
        ...
        (6, "Libertador General Bernardo O'Higgins", "VI", 8),
        (7, "Maule", "VII", 9),
        (16, "Ñuble", "XVI", 10),
        (8, "Biobío", "VIII", 11),
        (9, "La Araucanía", "IX", 12),
        (14, "Los Ríos", "XIV", 13),
        (10, "Los Lagos", "X", 14),
        (11, "Aysén del General Carlos Ibáñez del Campo", "XI", 15),
        (12, "Magallanes y de la Antártica Chilena", "XII", 16),
    ];

    internal static readonly (int Id, string Nombre, int RegionId)[] Comunas =
    [
        (1101, "Iquique", 1),
